...
/**
 * Before/after slider. Each pair has fallback hues — if the image URL fails
 * to load, the elegant gradient + filigree backdrop is what visitors see.
 * To swap any photo, just edit the `beforeUrl` / `afterUrl` strings below
 * (or set them to "" to force the gradient fallback).
 */
const PAIRS = [
  {
    id: 1,
  ...
  },
  {
    id: 2,
    beforeUrl:
      "https://images.unsplash.com/photo-1611077861393-d5f0ca0457f4?auto=format&fit=crop&w=900&q=80",
    afterUrl:
  ...
  },
  {
    ...
    afterUrl:
      "https://images.unsplash.com/photo-1612277539503-d8d6c9c2af86?auto=format&fit=crop&w=900&q=80",
    hueA: "165 35% 20%",
    hueB: "41 50% 60%",
  },
] as const;
...
function BeforeAfterCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* AFTER base layer — gradient fallback always present underneath */}
        <div
        ...
        {/* BEFORE overlay clipped by slider — also gradient + optional photo */}
        <div
          className="absolute inset-0"
          style={{
