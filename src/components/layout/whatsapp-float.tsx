...
export function WhatsAppFloat() {
  ...
  return (
    <motion.a
      href={waLink(siteConfig.contact.whatsappNumber, t("prefilled"))}
      target="_blank"
      ...
      whileTap={{ scale: 0.96 }}
      className="fixed bottom-5 end-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_-4px_rgba(37,211,102,0.5)] ring-4 ring-[#25D366]/15 transition-shadow hover:shadow-[0_12px_32px_-4px_rgba(37,211,102,0.6)]"
    >
